...
public class ModuleController {
    ...
    public ResponseEntity<Object> saveModule(@PathVariable(value = "courseId") UUID id,
    ...
    public ResponseEntity<Page<ModuleModel>> getAllModules(@PathVariable(value = "courseId")UUID courseId,
                                                           ...
                                                           @PageableDefault(page = 0, size = 10, sort = "moduleId", direction = Sort.Direction.ASC)
                                                               Pageable pageable){
        return ResponseEntity.status(HttpStatus.OK).body(moduleService.findAllByCourseId(SpecificationTemplate.findModulesByCourseId(courseId).and(spec), pageable));
    }
